                                    ...
                                    <div class="homelengo-box list-style-1 line">
                                        <div class="archive-top">
                                            <a href="{{ route('reserver') }}" class="images-group">
                                                <div class="images-style">
                                                    <img class="lazyload" data-src="{{ asset('storage/' . $property_form->image) }}" src="images/home/house-sm-11.jpg" alt="img-property">
                                                </div>
                                                <div class="top">
                                        ...
                                        <div class="archive-bottom">
                                            <div class="content-top">
                                                <h6 class="text-capitalize"><a href="{{ route('reserver') }}" class="link text-line-clamp-1">{{ $property_form->name }}</a></h6>
                                                <ul class="meta-list">
                                                    <li class="item">
